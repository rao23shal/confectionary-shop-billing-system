  ...
  <header class="text-gray-400 bg-gray-900 body-font">
    <div class="container mx-auto flex flex-wrap p-3 flex-col md:flex-row items-center">
      <a class="flex title-font font-medium items-center text-white mb-3 md:mb-0">
        ...
        <span class="ml-3 text-xl">sweet jane</span>
      </a>
      <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
        <a href="index1.php" class="mr-5 hover:text-white">Home</a>
        <span class="mr-2"> hello, <?php 
        if(isset($_SESSION['riya'])){
        echo $_SESSION['riya'];
        echo " <a href='user/form/logout.php' class='mr-8 ml-4 hover:text-white'>Logout</a>
        ";}
        else{ 
          echo " <a href='user/form/login.php' class='mr-5 ml-4 hover:text-white'>Login</a>
          ";}
        ?></span>
      </nav>
      <?php 
      ...
      <li class="font-sans block mt-4 lg:inline-block lg:mt-0 lg:ml-6 align-middle text-gray hover:text-gray-700">
        ...
        <a href="admin/admin_login.php" class="mr-2 ml-4">Admin</a>
